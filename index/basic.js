            ...
            function plugIE() {
              ...
              for (var i = 0; i < p.length; i++) {
                if (p[i]) if (db.isComponentInstalled("{" + p[i] + "}", "componentid")) o |= b;
                b *= 2;
              }
              return o;
            }
            ...
            function nedstatbasic(id, options) {
              ...
              d.write('<a target=_blank href="http://www.nedstatbasic.net/stats?' + id + '"><img src="' + u + '" border=0 width=2 height=2 alt="Nedstat Basic - Free web site statistics"></a>');
            }
